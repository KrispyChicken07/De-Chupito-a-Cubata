...
const squares = [
    { number: 1, text: "Insertar texto" },
    { number: 2, text: "Yo nunca nunca" },
    { number: 3, text: "Insertar texto" },
    { number: 4, text: "Pégale a alguien en el cachete" },
    { number: 5, text: "Avanza dos casillas", action: "move", amount: 2 },
    { number: 6, text: "Insertar texto" },
    { number: 7, text: "Insertar texto" },
    { number: 8, text: "Insertar texto" },
    { number: 9, text: "Insertar texto" },
    ...
    { number: 14, text: "Insertar texto" },
    { number: 15, text: "Insertar texto" },
    { number: 16, text: "Insertar texto" },
    { number: 17, text: "Insertar texto" },
    ...
    { number: 22, text: "Insertar texto" },
    { number: 23, text: "Insertar texto" },
    { number: 24, text: "Insertar texto" },
    { number: 25, text: "Insertar texto" },
    ...
    { number: 31, text: "Insertar texto" },
    { number: 32, text: "HIDRÁTATE" },
    { number: 33, text: "Insertar texto" },
